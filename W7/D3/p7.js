...
const userToken = jwt.sign({userId:1,role:"user",email:"p@gmail.com"},secretKey,{expiresIn:"1h"});
console.log("Usertoken:",userToken);

const adminToken = jwt.sign({userId:1,role:"admin",email:"m@gmail.com"},secretKey,{expiresIn:"1h"});
...
// curl http://localhost:4000/admin -H "Authorization:Bearer